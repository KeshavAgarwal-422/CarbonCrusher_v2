...
const Introduction = () => {
    ...
    return (
        <div className="w-full h-full flex flex-col mt-[14vw] items-center justify-start">
            <div className="h-[10vw] w-fit rounded-3xl bg-[#272727] flex justify-center items-center text-[4vw] px-3">{transportMode}</div>
            <div className='mt-[45vw] text-center'>
                <h1 className='text-[10vw]'>CarbonCrusher</h1>
                <span className='text-[3.5vw]'>Reshaping the Future, Sustaining the Earth</span>
                <div className='mt-[40vw]'><button
                    type="button"
                    onClick={() => nav("/login")}
